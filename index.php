        ...
        <section class="news" id="news">
            ...
            <ul class="news__list">
                <li class="news__item fadeInAndUp-target">
                    <a href="<?php echo get_permalink(get_page_by_path('news')); ?>" class="news__link">
                        <time datetime="2024-04-02" class="news__itemtime text__newstime">
                            2024.04.02
                        </time>
                        ...
                        <p class="news__itemdesc text__newsdesc">
                            平素は格別のお引き立てを賜り誠にありがとうございます。ホームページを公開いたしました。
                        </p>
                    </a>
                </li>
            </ul>
